...
# cloning device tree
git clone https://github.com/Sepidermn/android_device_xiaomi_mojito.git --depth 1 -b lineage device/xiaomi/mojito
git clone https://github.com/Sepidermn/android_device_xiaomi_sm6150-common.git --depth 1 -b ros device/xiaomi/sm6150-common

# cloning kernel tree
git clone https://github.com/Sepidermn/android_kernel_xiaomi_mojito.git --depth 1 -b mist kernel/xiaomi/mojito
...
# add leica
git clone https://gitlab.com/Kou-Yeager/android_vendor_xiaomi_mojito-leicacamera-qpr2.git -b main vendor/xiaomi/mojito-leicacamera/qpr2
